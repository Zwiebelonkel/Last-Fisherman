...
func _ready() -> void:
	apply_manual_water_tags_to_all_fish()
...
const FISH_WATER_TAG_BY_ID := {
	# LAKE
	"SEETANG": WATER_TAGS.SPECIAL,
	"MAKRELE": WATER_TAGS.ATLANTIC,
	"BRASSE": WATER_TAGS.SPECIAL,
	"HOLZ": WATER_TAGS.SPECIAL,
	"STIEFEL": WATER_TAGS.SPECIAL,
	"ROTAUGE": WATER_TAGS.SPECIAL,
	"BARSCH": WATER_TAGS.SPECIAL,
	"AUGENFORELLE": WATER_TAGS.SPECIAL,
	"DOEBEL": WATER_TAGS.SPECIAL,
	"THUNFISCH": WATER_TAGS.ATLANTIC,
	"SCHLAMMGEIST": WATER_TAGS.SPECIAL,
	"HECHT": WATER_TAGS.SPECIAL,
	"EINSIEDLER": WATER_TAGS.MEDITERRANEAN,
	"SPIEGELKARPFEN": WATER_TAGS.SPECIAL,
	"SEEPFERD": WATER_TAGS.MEDITERRANEAN,
	"MANTA": WATER_TAGS.INDIAN,
	"ZANDER": WATER_TAGS.SPECIAL,
	"TIEFENHUSTLER": WATER_TAGS.SPECIAL,
	"KORALLE": WATER_TAGS.INDIAN,
	"KAUGUMMIKARPFEN": WATER_TAGS.SPECIAL,
	"GLUBSCHI": WATER_TAGS.SPECIAL,
	"KARPFENKOENIGIN": WATER_TAGS.SPECIAL,
	"ANLEITUNG": WATER_TAGS.SPECIAL,
	"GEISTERFORELLE": WATER_TAGS.SPECIAL,
	"PLUTONIUM": WATER_TAGS.SPECIAL,
	"ROTER_KNOPF": WATER_TAGS.SPECIAL,

	# CITY
	"DOSE": WATER_TAGS.SPECIAL,
	"FLASCHE": WATER_TAGS.SPECIAL,
	"SAND_AAL": WATER_TAGS.ATLANTIC,
	"SIGNALFAENGER": WATER_TAGS.SPECIAL,
	"SEEIGEL": WATER_TAGS.ATLANTIC,
	"ROEHRE": WATER_TAGS.SPECIAL,
	"RETTUNGSRING": WATER_TAGS.SPECIAL,
	"HDMI": WATER_TAGS.SPECIAL,
	"DARKCRAB": WATER_TAGS.ATLANTIC,
	"TRUEMMERKABEL_FISCH": WATER_TAGS.SPECIAL,
	"METALLAAL": WATER_TAGS.SPECIAL,
	"DORSCH": WATER_TAGS.ATLANTIC,
	"VEGAN": WATER_TAGS.SPECIAL,
	"DISKUSFISCH": WATER_TAGS.SPECIAL,
	"SCHATTENKOI": WATER_TAGS.SPECIAL,
	"BARRAKUDA": WATER_TAGS.ATLANTIC,
	"LOAF_FISH": WATER_TAGS.SPECIAL,
	"WHITE_DOG": WATER_TAGS.SPECIAL,
	"NEONFLOSSER": WATER_TAGS.SPECIAL,
	"RADIOAKTIV": WATER_TAGS.SPECIAL,
	"ABFLUSSENGEL": WATER_TAGS.SPECIAL,
	"ZIGARETTEN": WATER_TAGS.SPECIAL,
	"SEATURTLE": WATER_TAGS.ATLANTIC,
	"ALTSTADTGEIST": WATER_TAGS.SPECIAL,
	"BULLENHAI": WATER_TAGS.ATLANTIC,
	"PLATZHALTER": WATER_TAGS.SPECIAL,
	"LEICHE": WATER_TAGS.SPECIAL,
	"DATENKRAKE": WATER_TAGS.PACIFIC,
	"STOEPSEL": WATER_TAGS.SPECIAL,

	# SEWER
	"TOILETPAPER": WATER_TAGS.SPECIAL,
	"HERING": WATER_TAGS.ATLANTIC,
	"KACKWURST": WATER_TAGS.SPECIAL,
	"SARDINE": WATER_TAGS.MEDITERRANEAN,
	"FORELLE": WATER_TAGS.SPECIAL,
	"WELS": WATER_TAGS.SPECIAL,
	"SEEPFERD2": WATER_TAGS.MEDITERRANEAN,
	"SIFFZUNGE": WATER_TAGS.SPECIAL,
	"TEERFISCH": WATER_TAGS.SPECIAL,
	"KLOAKENHECHT": WATER_TAGS.SPECIAL,
	"KARTOFFEL": WATER_TAGS.SPECIAL,
	"MONDFISCH": WATER_TAGS.PACIFIC,
	"KATZENHAI": WATER_TAGS.ATLANTIC,
	"GERUCHSFISCH": WATER_TAGS.SPECIAL,
	"FUEHRERSCHEIN": WATER_TAGS.SPECIAL,
	"GIFT_MANTA": WATER_TAGS.INDIAN,
	"BILDERBUCHFISCH": WATER_TAGS.SPECIAL,
	"WUETENDE_SCHOLLE": WATER_TAGS.ATLANTIC,
	"KONDOM": WATER_TAGS.SPECIAL,
	"BAHNKARTE": WATER_TAGS.SPECIAL,

	# FOREST
	"KARPFEN": WATER_TAGS.SPECIAL,
	"WELS_FOREST": WATER_TAGS.SPECIAL,
	"KOI": WATER_TAGS.SPECIAL,
	"MOOSWELS": WATER_TAGS.SPECIAL,
	"CLOWNFISH": WATER_TAGS.INDIAN,
	"ROHRSCHATTEN": WATER_TAGS.SPECIAL,
	"NEBELBISS": WATER_TAGS.SPECIAL,
	"ANGEL": WATER_TAGS.SPECIAL,
	"WALDAAL": WATER_TAGS.SPECIAL,
	"WALDFRESSER": WATER_TAGS.SPECIAL,
	"KUGELFISCH": WATER_TAGS.PACIFIC,
	"WURMFUERST": WATER_TAGS.SPECIAL,
	"BAMBUSHAI": WATER_TAGS.PACIFIC,
	"ANGEPISSTE_MAKRELE": WATER_TAGS.ATLANTIC,
	"WURZELFISCH": WATER_TAGS.SPECIAL,
	"MARKUS": WATER_TAGS.SPECIAL,
	"HAIZAHN": WATER_TAGS.SPECIAL,

	# DESERT
	"SANDKORN": WATER_TAGS.SPECIAL,
	"KOKOSNUSS": WATER_TAGS.INDIAN,
	"SCHMUTZGRUNDEL": WATER_TAGS.INDIAN,
	"SOLARFAENGER": WATER_TAGS.SPECIAL,
	"ROSTFLOSSER": WATER_TAGS.SPECIAL,
	"KOKOSNUSS2": WATER_TAGS.INDIAN,
	"FLIMMERAAL": WATER_TAGS.INDIAN,
	"BETTA": WATER_TAGS.INDIAN,
	"SANDSTREIFER": WATER_TAGS.SPECIAL,
	"SALZFRESSER": WATER_TAGS.SPECIAL,
	"STEINSCHNECKE": WATER_TAGS.SPECIAL,
	"AGGRESIVE_GARNELE": WATER_TAGS.INDIAN,
	"STAUBHAI": WATER_TAGS.SPECIAL,
	"DUENENHAI": WATER_TAGS.SPECIAL,
	"WASSERFISCH": WATER_TAGS.SPECIAL,
	"FEUER_MANTA": WATER_TAGS.INDIAN,
	"PAN": WATER_TAGS.SPECIAL,
	"SONNENFRAGMENT": WATER_TAGS.SPECIAL,
	"GOLDHAI": WATER_TAGS.INDIAN,
	"BENZIN": WATER_TAGS.SPECIAL,

	# ICELAND
	"LODDE": WATER_TAGS.ARCTIC,
	"ICECUBE": WATER_TAGS.ARCTIC,
	"SNAILFISCH": WATER_TAGS.ARCTIC,
	"SEESTERN": WATER_TAGS.ARCTIC,
	"PATRICK": WATER_TAGS.ARCTIC,
	"BATHYANTHIAS": WATER_TAGS.ATLANTIC,
	"EISFISCH": WATER_TAGS.SOUTHERN,
	"FROSTMAUL": WATER_TAGS.ARCTIC,
	"ANGLERFISCH": WATER_TAGS.ATLANTIC,
	"BLOBFISCH": WATER_TAGS.PACIFIC,
	"EISLICHT": WATER_TAGS.ARCTIC,
	"BLAUER_MARLIN": WATER_TAGS.ATLANTIC,
	"OARFISH": WATER_TAGS.PACIFIC,
	"KRISTALL_FISCH": WATER_TAGS.ARCTIC,
	"GLETSCHERZUNGE": WATER_TAGS.ARCTIC,
	"SCHWARZER_MARLIN": WATER_TAGS.PACIFIC,
	"MEGALODON": WATER_TAGS.PACIFIC,
	"PINGUIN": WATER_TAGS.SOUTHERN,

	# OCEAN
	"STEAM_PLAYER": WATER_TAGS.PACIFIC
}
...
func apply_manual_water_tags_to_all_fish() -> void:
	for list in [FISH_LAKE, FISH_CITY, FISH_SEWER, FISH_FOREST, FISH_DESERT, FISH_ICELAND, FISH_OCEAN]:
		for fish in list:
			var id := String(fish.get("id", ""))
			fish["water_tag"] = FISH_WATER_TAG_BY_ID.get(id, WATER_TAGS.SPECIAL)
# ===========================
